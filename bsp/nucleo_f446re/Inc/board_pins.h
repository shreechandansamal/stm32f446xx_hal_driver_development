...
/****************************keyboard_5x10 port, pin and other configuration******************************/
/* Matrix size */
#define KB_ROWS    5
#define KB_COLS    10
...
/*********************ds1307_rtc peripheral, port, pin and other configuration***************************/

#define DS1307_I2C_PERI				I2C1
#define DS1307_I2C_PORT				GPIOB
#define DS1307_I2C_SCL_PIN			GPIO_PIN_NO_6
#define DS1307_I2C_SDA_PIN			GPIO_PIN_NO_7
#define DS1307_I2C_SCL_ALT_MODE 	GPIO_MODE_ALTFN_AF4
#define DS1307_I2C_SDA_ALT_MODE 	GPIO_MODE_ALTFN_AF4
#define DS1307_I2C_PUPD				GPIO_PIN_NO_PUPD //used external pull-ups
#define DS1307_I2C_SPEED			I2C_SCL_SPEED_SM //device supports only standard mode
#define DS1307_I2C_ACK_CTRL			I2C_ACK_ENABLE
/********************************************************************************************************/
